...
tag to tell browsers to render the gaps.
            ...
            <div id="wd-lists">
                ...
                <li>Put 1 piece of bread in the toaster.</li>
                <li>Crack 2 eggs over a pan medium heat.</li>
                <li>Sprinkle water around the egg.</li>
                <li>Cover eggs with lid and let cook for 5 min.</li>
                <li>In the meantime, cut a few slices of avocado.</li>
                <li>Take toast out of toaster and spread butter on it.</li>
                <li>Add avocado slices and everything bagel seasoning to toast.</li>
                <li>Add egg on top and season with salt and pepper.</li>
                <li>Serve and enjoy your breakfast!</li>
                </ol>
...
Please
<a href="https://github.com/giaptl/kambaz-next-js" id="wd-github"> click here </a>
to get my github repo<br/>
